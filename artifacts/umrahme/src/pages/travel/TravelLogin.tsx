      ...
      >
        ...
        <div className="px-8 pt-8 pb-9">
          <div className="mb-8">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[13px] mt-1" style={{ color: '#9ca3af' }}>
              Masuk untuk mengelola jamaah Anda.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onFocus={e => {
                  ...
                  e.currentTarget.style.boxShadow = '0 0 0 3px rgba(14,165,233,0.12), inset 0 1px 2px rgba(0,0,0,0.02)';
            ...
            <button
              ...
              style={{
                ...
                color: '#ffffff',
                boxShadow: loading ? 'none' : '0 2px 8px rgba(14,165,233,0.30), 0 1px 2px rgba(14,165,233,0.20)',
                marginTop: '4px',
              }}
            >
              {loading ? (
