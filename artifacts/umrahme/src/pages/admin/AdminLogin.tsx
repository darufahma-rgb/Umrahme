    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, #4338ca 0%, #6366f1 100%)' }}
        />
        ...
        <div className="px-8 pt-8 pb-9">
          ...
          <div className="mb-8">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4338ca" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[13px] mt-1" style={{ color: '#9ca3af' }}>
              Masuk untuk mengelola tenant Umrahme.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onFocus={e => {
                  ...
                  e.currentTarget.style.boxShadow = '0 0 0 3px rgba(67,56,202,0.10), inset 0 1px 2px rgba(0,0,0,0.02)';
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full font-semibold text-sm rounded-xl py-3 transition-all duration-150 active:scale-[0.99] disabled:opacity-60"
              style={{
                background: loading
                  ? '#6366f1'
                  : 'linear-gradient(135deg, #4338ca 0%, #4f46e5 100%)',
                color: '#ffffff',
                boxShadow: loading ? 'none' : '0 2px 8px rgba(67,56,202,0.28), 0 1px 2px rgba(67,56,202,0.20)',
                marginTop: '4px',
              }}
            >
              {loading ? (
