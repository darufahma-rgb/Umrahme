    ...
    bagianGrup: [
      {
        ...
        items: [
          { nama: 'Rukun Hajar Aswad', arab: 'ركن الحجر الأسود', deskripsi: 'Sudut timur, tempat Hajar Aswad. Titik awal & akhir tawaf. Disunnahkan mencium atau memberi isyarat tangan ke arahnya tiap memulai putaran.', gambar: '/lokasi/kabah/rukun-hajar-aswad.jpg' },
          { nama: 'Rukun Yamani', arab: 'الركن اليماني', deskripsi: 'Sudut barat daya (mengarah Yaman). Disunnahkan mengusapnya dengan tangan kanan tanpa mencium. Antara Rukun Yamani & Hajar Aswad dianjurkan membaca \u201cRabbana atina fid-dunya hasanah\u2026\u201d', gambar: '/lokasi/kabah/rukun-yamani.jpg' },
          { nama: 'Rukun Iraqi', arab: 'الركن العراقي', deskripsi: 'Sudut utara (mengarah Irak). Tidak ada amalan khusus, menjadi penanda dalam tawaf.', gambar: '/lokasi/kabah/rukun-iraqi.jpg' },
          { nama: 'Rukun Syami', arab: 'الركن الشامي', deskripsi: 'Sudut barat laut (mengarah Syam). Disebut juga Rukun Maghribi. Tidak ada amalan khusus.', gambar: '/lokasi/kabah/rukun-syami.jpg' },
        ],
      },
      {
        judul: 'Bagian Penting Lainnya',
        items: [
          { nama: 'Multazam', arab: 'الملتزم', deskripsi: 'Dinding antara Hajar Aswad & pintu Ka\u2019bah; tempat mustajab berdoa. Disunnahkan menempelkan dada & tangan ke dinding bila memungkinkan.', gambar: '/lokasi/kabah/multazam.jpg' },
          { nama: 'Maqam Ibrahim', arab: 'مقام إبراهيم', deskripsi: 'Batu berisi bekas pijakan Nabi Ibrahim saat membangun Ka\u2019bah (bukan makam). Disunnahkan shalat 2 rakaat di belakangnya setelah tawaf.', gambar: '/lokasi/kabah/maqam-ibrahim.jpg' },
          { nama: 'Hijir Ismail', arab: 'حجر إسماعيل', deskripsi: 'Area setengah lingkaran di sisi utara (disebut Al-Hathim). Termasuk bagian asli Ka\u2019bah, maka tawaf wajib mengelilingi di luar pagarnya.', gambar: '/lokasi/kabah/hijir-ismail.jpg' },
          { nama: 'Pintu Ka\u2019bah', arab: 'باب الكعبة', deskripsi: 'Terbuat dari emas murni, ditinggikan dari permukaan tanah. Berat kedua daun pintu sekitar 280 kg.', gambar: '/lokasi/kabah/pintu-kabah.jpg' },
          { nama: 'Mizab Ar-Rahman', arab: 'ميزاب الرحمة', deskripsi: 'Pancuran/talang emas di atap (di atas Hijir Ismail) untuk mengalirkan air hujan. Disebut \u201cpancuran rahmat\u201d.', gambar: '/lokasi/kabah/mizab-ar-rahman.jpg' },
          { nama: 'Kiswah', arab: 'كسوة الكعبة', deskripsi: 'Kain hitam berhias kaligrafi benang emas yang menyelubungi Ka\u2019bah, diganti setiap tahun pada 9 Dzulhijjah.', gambar: '/lokasi/kabah/kiswah.jpg' },
          { nama: 'Syadzarwan', arab: 'الشاذروان', deskripsi: 'Bagian dasar Ka\u2019bah yang menonjol. Termasuk bagian Ka\u2019bah, maka saat tawaf jangan menapak di atasnya.', gambar: '/lokasi/kabah/syadzarwan.jpg' },
        ],
      },
    ],
  },
